...
```
The scatter plot above looks like it is going more towards the right. I suspect there is a positive correlation.
...
The equation of a line is y=m+b. 
...
```
This is the best fit line for our data. We can see that if we look value of 0.7 it is predicted to fall into place.
...
Model 1 has a smaller RSS of 217.88. We can say Model 1 is the best model due to the less amount of errors. SIMS ~ ARM can be named the better.
